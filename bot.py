...
async def cmd_start(message: types.Message):
    ...
    await message.answer_photo(
        ...
        caption=(
             ...
             "🔹 Запускаем и оптимизируем таргетированную рекламу\n"
             "🔹 Строим стратегию продвижения и воронки продаж\n"
             "🔹 Автоматизируем процессы и повышаем конверсию\n\n"
             "Наша команда состоит из специалистов в области digital-маркетинга, "
             "аналитики и веб-разработки. Мы не работаем «ради отчётов» — "
             "мы работаем на результат.\n\n"
             "Наша цель — не просто запустить рекламу, а выстроить систему, "
             "которая стабильно приносит заявки и масштабируется.\n\n"
             "📩 Чтобы получить расчёт или предложение по вашему проекту, "
             "кратко опишите:\n"
             "— Чем занимается ваш бизнес\n"
             "— Что именно хотите продвигать\n"
             "— Есть ли уже сайт или реклама\n\n"
             "После этого команда изучит информацию и свяжется с вами в этом чате.\n\n"
...
async def handle_promo(message: types.Message):
    ...
    await message.answer(
    "📝 Пожалуйста, отправьте ваше предложение по продвижению.\n\n"
    "Мы внимательно его рассмотрим и передадим администрации для дальнейшего обсуждения."
)
